...
var ExpressionTracer = (function(){
  ...
  function compile(source) {
    ...
    if (ok) {
      ...
      var fun = new Function("b", "return "+res.join(" ")+";");
      var result = {fun:fun, paths:paths};
      if (res.length === 1) {
        if (isLit) {
